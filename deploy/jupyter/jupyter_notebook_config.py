...
c = get_config()  #noqa
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$pb/Msn+x9ZYTgZ8eZvc7Ag$1RReCUzTN+msy4Ht93Veleq8P2VQEHFFBFgfG7dkPCE'
#------------------------------------------------------------------------------
...
#  Choices: any of ['sha3_256', 'blake2s', 'sha3_384', 'blake2b', 'sha384', 'sha512', 'sha1', 'sha224', 'md5', 'sha3_512', 'sha3_224', 'sha256']
#  Default: 'sha256'
